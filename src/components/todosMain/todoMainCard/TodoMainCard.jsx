        ...
        <div className='todoMainCard__footer'>
            ...
            <div className='todoMainCard__footer__right'>
                <div className='todoMainCard__footer__right__prev'>
                    <FontAwesomeIcon color='gray' style={{fontSize:'22px'}} icon={faChevronCircleLeft} />
                </div>
                <div className='todoMainCard__footer__right__start'>
                    <div style={{backgroundColor:'gray',borderRadius:'50%',width:'22px',height:'22px', display:'flex',justifyContent:'center',alignItems:'center'}} className='todoMainCard__footer__right__start__style'>
                        <p style={{fontSize:'10px'}}>{paginationCount}</p>
                    </div>
                </div>
                <div className='todoMainCard__footer__right__truncate'>
                    <h3>{`. . .`}</h3>
                </div>
                <div style={{backgroundColor:'gray',borderRadius:'50%',width:'22px',height:'22px', display:'flex',justifyContent:'center',alignItems:'center'}} className='todoMainCard__footer__right__end'>
                ...
                <div className='todoMainCard__footer__right__next'>
                    <FontAwesomeIcon color='gray' style={{fontSize:'22px'}} icon={faChevronCircleRight} />
                </div>
            </div>
        </div>
    </div>
